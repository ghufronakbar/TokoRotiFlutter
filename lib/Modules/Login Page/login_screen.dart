...
class _LoginPageState extends State<LoginPage> {
  ...
  void fetchPreferences() async {
    ...
    bool canManageAccount = prefs.getBool('can_manage_account') ?? false;
    bool canManageItems = prefs.getBool('can_manage_items') ?? false;
    bool canManageTransactions =
        prefs.getBool('can_manage_transactions') ?? false;
    bool canManageReports = prefs.getBool('can_manage_reports') ?? false;

    // Debug logging untuk memastikan data yang diambil dari shared preferences
    print('Nama User: $namaUser');
    print('Can Manage Account: $canManageAccount');
    print('Can Manage Items: $canManageItems');
    print('Can Manage Transactions: $canManageTransactions');
    print('Can Manage Reports: $canManageReports');

    if(namaUser != null) {
      // Jika nama pengguna sudah ada, navigasikan ke halaman beranda
